(function (soccerDeleteDialog) {
    ...
    */
    function openModal(modalName, classOrId,
        sourceEvent, deletePath, eventClassOrId) {
        ...
        $(textEvent).click((e) => {
            ...
            deleteItem(sourceEvent, deletePath,
                eventClassOrId);
        });
    ...
    * @return void. 
    */
    function deleteItem(sourceEvent, deletePath,
        eventClassOrId) {
        var textEvent;
        if (eventClassOrId) {
